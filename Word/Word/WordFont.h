...
class WordFont : public COleDispatchDriver
{
public:
	WordFont(){} // 调用 COleDispatchDriver 默认构造函数
	WordFont(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	WordFont(const WordFont& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
