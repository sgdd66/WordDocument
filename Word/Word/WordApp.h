...
class WordApp : public COleDispatchDriver
{
public:
	WordApp(){} // 调用 COleDispatchDriver 默认构造函数
	WordApp(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	WordApp(const WordApp& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
