...
class WordTables : public COleDispatchDriver
{
public:
	WordTables(){} // 调用 COleDispatchDriver 默认构造函数
	WordTables(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	WordTables(const WordTables& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
