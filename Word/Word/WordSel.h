...
class WordSel : public COleDispatchDriver
{
public:
	WordSel(){} // 调用 COleDispatchDriver 默认构造函数
	WordSel(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	WordSel(const WordSel& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
