...
class WordDocs : public COleDispatchDriver
{
public:
	WordDocs(){} // 调用 COleDispatchDriver 默认构造函数
	WordDocs(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	WordDocs(const WordDocs& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
