...
class WordDoc : public COleDispatchDriver
{
public:
	WordDoc(){} // 调用 COleDispatchDriver 默认构造函数
	WordDoc(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	WordDoc(const WordDoc& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
