...
class WordRange : public COleDispatchDriver
{
public:
	WordRange(){} // 调用 COleDispatchDriver 默认构造函数
	WordRange(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	WordRange(const WordRange& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
