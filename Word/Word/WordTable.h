...
class WordTable : public COleDispatchDriver
{
public:
	WordTable(){} // 调用 COleDispatchDriver 默认构造函数
	WordTable(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	WordTable(const WordTable& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
